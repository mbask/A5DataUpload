...
```{r "timeLineChart", results='asis', tidy=FALSE}
...
#
submissionWindowParameters$action <- ifelse(submissionWindowParameters$action == "uploadedDate", "Uploaded datasets", "Metadated datasets")

ggplot(submissionWindowParameters) +
  ...
  ggtitle("Time line of A5 data submissions") +
  facet_grid(countryName~action) +
  theme_bw()
