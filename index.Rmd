...
paramAggrDate_df$submissionDate <- as.Date(paramAggrDate_df$submissionDate)

paramAggrDate_df <- ddply(
  paramAggrDate_df
  , .(siteLTERCode, domainName, submissionDate, action, countryName)
  , summarise
  , totParameters = sum(totParameters)
  , parameterNum  = sum(parameterNum)
  )

paramAggrDate_df$submissionRatio <- with(paramAggrDate_df, parameterNum / totParameters)
